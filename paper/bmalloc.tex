...
\begin{enumerate}
 ...
 \item Why do we need the caches?
  ...
  For large objects, we the cache is really of objects that are not demapped.  (\url{http://lists.freebsd.org/pipermail/freebsd-arch/2012-October/013287.html} says 
\begin{quote}
