...
must be 4-byte aligned, we might see a call to \code{malloc(11)}
specify $11$ bytes ($4$ for the integer, and $7$ more for the array).
...
unable to see the advantage of late lock subscription.\bcknote{Note that we probably should try to do late lock.}
...
the Apache 2.0 or GPLv3 licenses.
...
Michael A. Bender helped me understand how to implement the
fullest-fit priority queue.  This research was supported in part by
Foxconn, and in part by NSF grants CCF-1314547, CNS-1409238, and
IIS-1447786.
