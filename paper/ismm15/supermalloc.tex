...
\bcknote{Switch to powers of two for less than a cache line.  Discuss how this will make everything work right, so that people won't have to call aligned\_malloc in order to use avx instructions.}
