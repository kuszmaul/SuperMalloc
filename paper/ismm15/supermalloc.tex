...
Hoard uses thread-local allocation, and when the thread cache empties,
uses an \defn{allocate-fullest} heuristic.  Hoard sometimes finds
itself in a situation where an object could be allocated out of any
one of several superblocks.  Hoard allocates the object out of the
...
how Hoard works and pointed out \cite{HertzFeBe05, YangBeKa06}.
