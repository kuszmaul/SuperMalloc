...
\figref{gs}.  GS apparently allocates large objects and runs its own
...
Instead of measuring throughput (which is operations per second), we
...
\units{81}\milli\second, and it wasn't clear that any of the
...
\begin{center}
\begin{tabular}{lrrr}
             & Mean Time/op            & $\sigma$              &Slowest & Max RSS \\
...
%%  LocalWords:  mutexes Hyperthreading Ghostscript
