...
x86.  In operating systems that support huge-page page tables, chunks
align properly with the paging.  For objects that are significantly
...
The bookkeeping comprises a bitmap
...
%%  LocalWords:  metadata unallocated
