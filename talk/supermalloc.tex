...
For jemalloc, once per day \mintinline{c}{free()} takes 3 seconds.

I suspect it's lock convoying, but it's tough to observe.
\end{frame}
...
\item Preloading the cache seems not to help.
